...
{
	m_DxDevice->GetCommandList().Get()->SetPipelineState(GetPSO("opaque").Get());
...
{
	m_Shaders["stdVS"] = CShaderCompiler::CompileShader(L"../Shaders/Default.hlsl", nullptr, "VS", "vs_5_0");
