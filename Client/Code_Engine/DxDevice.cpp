...
HRESULT DxDevice::InitDxDevice()
{
	...
	if (FAILED(InitDirect3D_Device()))
		return E_FAIL;

	if (FAILED(InitDirect3D_Environment()))
		return E_FAIL;
...
HRESULT DxDevice::InitDirect3D_Device()
{
...
HRESULT DxDevice::InitDirect3D_Environment()
{
...
void DxDevice::CreateCommandObjects()
{
...
void DxDevice::BuildDescriptorHeaps()
{

}

void DxDevice::BuildConstantBuffers()
{

}

void DxDevice::BuildRootSignature()
{

}

void DxDevice::BuildShadersAndInputLayout()
{

}

void DxDevice::BuildPSO()
{
