...
//void DxDevice::SetClientSize(int width, int height)
//{
//	m_ClientWidth = width;
...
//}
//
//void DxDevice::SetMainWnd(const HWND& mainWnd)
//{
//	m_hMainWnd = mainWnd;
//}
